    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // /charge is called via Feign with the original
                        // caller's forwarded JWT (order-service acts on
                        // the user's behalf, not as a separate service
                        // identity), so "authenticated" is the right bar.
